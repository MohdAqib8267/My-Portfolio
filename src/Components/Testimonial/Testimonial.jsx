  ...
  const clients = [
    {
      img: profilePic1,
      review:
        "I have Excellent knowledge of Data Structure & Algorithms.I have Solved 400+ Problems on Leetcode and i have algo good experience and efficeintly use C++.",
    },
    {
      img: profilePic2,
      review:
    ...
    },
    {
      img: profilePic3,
      review:
       "I am currently in 3rd Year of BTech from Jamia millia islamia(New Delhi).My branch is Electronics and Communication Engineering."+
        "I got 9.67 SPI in my last academic year.",
    },
    {
      img: profilePic4,
      review:
